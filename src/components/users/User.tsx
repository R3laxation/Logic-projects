...
export const User = ({id, email, first_name, last_name, avatar, onClickInvite, isInvited}: UserType) => (
    <li>
        <div>
        ...
        <img onClick={() => onClickInvite(id)} className={s.action} src={`/assets/${isInvited ? `minus` : `plus`}.svg`}
             alt="Action"/>
    </li>
);
